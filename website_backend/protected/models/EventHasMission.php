 ...
 * @property Event $emEvent
 * @property Mission $emMission
 */
class EventHasMission extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('em_mission_id, em_event_id', 'required'),
			array('em_mission_id, em_event_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, em_mission_id, em_event_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'emEvent' => array(self::BELONGS_TO, 'Event', 'em_event_id'),
			'emMission' => array(self::BELONGS_TO, 'Mission', 'em_mission_id'),
		);
	}
