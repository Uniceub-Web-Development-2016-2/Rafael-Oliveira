...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('deleted_at, last_login', 'safe'),
	...
	public function relations()
	{
		...
		return array(
			'missionCompleteds' => array(self::HAS_MANY, 'MissionCompleted', 'user_id_fk'),
			'userHasRewards' => array(self::HAS_MANY, 'UserHasReward', 'user_id'),
		);
	}
